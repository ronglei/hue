...
class HiveServerClient:
  ...
  def execute_query(self, query, max_rows=10000):
  ...
  def execute_query_statement(self, statement, max_rows=10000, configuration={}):
  ...
  def execute_statement(self, statement, max_rows=10000, configuration={}):
